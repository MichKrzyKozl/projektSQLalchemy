...
movies = [
    Movie(title="Inception", release_date=date(2010, 7, 16), runtime_minutes=148),
    Movie(title="The Matrix", release_date=date(1999, 3, 31), runtime_minutes=136),
    Movie(title="Avengers: Endgame", release_date=date(2019, 4, 26), runtime_minutes=181),
    Movie(title="Lucy", release_date=date(2014, 7, 25), runtime_minutes=89),
    Movie(title="Forrest Gump", release_date=date(1994, 7, 6), runtime_minutes=142),
    Movie(title="The Hunger Games", release_date=date(2012, 3, 23), runtime_minutes=142),
    Movie(title="Man of Steel", release_date=date(2013, 6, 14), runtime_minutes=143),
    Movie(title="Interstellar", release_date=date(2014, 11, 7), runtime_minutes=169),
    Movie(title="Oppenheimer", release_date=date(2023, 7, 21), runtime_minutes=180),
    Movie(title="Barbie", release_date=date(2023, 7, 21), runtime_minutes=114),
    Movie(title="The Dark Knight", release_date=date(2008, 7, 18), runtime_minutes=152),
    Movie(title="Interstellar 2", release_date=date(2026, 1, 1), runtime_minutes=175),
    Movie(title="Dune", release_date=date(2021, 10, 22), runtime_minutes=155),
    Movie(title="Dune: Part Two", release_date=date(2024, 3, 1), runtime_minutes=166),
    Movie(title="Fight Club", release_date=date(1999, 10, 15), runtime_minutes=139),
    Movie(title="The Prestige", release_date=date(2006, 10, 20), runtime_minutes=130),
    Movie(title="La La Land", release_date=date(2016, 12, 9), runtime_minutes=128),
    Movie(title="Joker", release_date=date(2019, 10, 4), runtime_minutes=122),
    Movie(title="Black Swan", release_date=date(2010, 12, 17), runtime_minutes=108),
    Movie(title="Doctor Strange", release_date=date(2016, 11, 4), runtime_minutes=115),
    Movie(title="Spider-Man: No Way Home", release_date=date(2021, 12, 17), runtime_minutes=148),
    Movie(title="Midsommar", release_date=date(2019, 7, 3), runtime_minutes=147),
    Movie(title="Drive", release_date=date(2011, 9, 16), runtime_minutes=100),
    Movie(title="The Queen's Gambit Movie", release_date=date(2025, 5, 1), runtime_minutes=140),
]
...
series = [
    Series(title="Stranger Things", release_date=date(2016, 7, 15), seasons=4),
    Series(title="The Witcher", release_date=date(2019, 12, 20), seasons=3),
    Series(title="Loki", release_date=date(2021, 6, 9), seasons=2),
    Series(title="Black Mirror", release_date=date(2011, 12, 4), seasons=5),
    Series(title="Breaking Bad", release_date=date(2008, 1, 20), seasons=5),
    Series(title="Sherlock", release_date=date(2010, 7, 25), seasons=4),
    Series(title="House of the Dragon", release_date=date(2022, 8, 21), seasons=2),
    Series(title="The Last of Us", release_date=date(2023, 1, 15), seasons=2),
    Series(title="Peaky Blinders", release_date=date(2013, 9, 12), seasons=6),
    Series(title="Dark", release_date=date(2017, 12, 1), seasons=3),
    Series(title="Wednesday", release_date=date(2022, 11, 23), seasons=2),
    Series(title="The Boys", release_date=date(2019, 7, 26), seasons=4),
    Series(title="True Detective", release_date=date(2014, 1, 12), seasons=4),
    Series(title="Euphoria", release_date=date(2019, 6, 16), seasons=2),
    Series(title="The Queen's Gambit", release_date=date(2020, 10, 23), seasons=1),
    Series(title="Moon Knight", release_date=date(2022, 3, 30), seasons=1),
    Series(title="Andor", release_date=date(2022, 9, 21), seasons=2),
    Series(title="Arcane", release_date=date(2021, 11, 6), seasons=2),
    Series(title="Severance", release_date=date(2022, 2, 18), seasons=2),
]
